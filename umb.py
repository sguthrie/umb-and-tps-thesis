...
def analyze_umbsamp(dcd_filepath, psf_filepath, is_dori, moltype, r1, r2, refstruc_filepath, bigref_filepath):
            ...
            for line in logfile:
                ...
                if m != None:
                    ...
                    try:
                        ...
                        f = open(dcdpath, 'r')
                        f.close()
                        ensemble = analyze_umbsamp(dcdpath, psfpath, isdori, moltype, float(r1), float(r2), smrefpath, bigrefpath)
